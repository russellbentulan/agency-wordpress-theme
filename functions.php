...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	function add_custom_sizes() {
		...
		add_image_size('larger_square', 600, 600, true);
		add_image_size('hero', 1400, 800, false);
		add_image_size('single_page_feature', 755, 585, true);
	}
...
wp_deregister_script('jquery');
  ...
  wp_enqueue_script(
	  'fontawesome',
	  "http" . ($_SERVER['SERVER_PORT'] == 443 ? "s" : "") . "://kit.fontawesome.com/ff995803cc.js",
	  false,
	  null,
	  false
  );
...
function base_theme_continue_reading_link() {
	return ' <a href="'. get_permalink() . '" class="button blog-entry__link">Read more</a>';
}
...
function base_theme_posted_on() {
	printf('<span class="meta-sep">By</span> %3$s',
